...
const produkList = [
    ...
    { id: 26,nama: 'sunlight', harga:0,gambar:''},
    { id: 27,nama: 'mama lime', harga:0,gambar:''},
    { id: 28,nama: 'sunlight (B)', harga:0,gambar:''},
    { id: 29,nama: 'charm orange', harga:0,gambar:''},
    { id: 30,nama: 'charm night', harga:0,gambar:''},
    { id: 31,nama: 'nutrijel', harga:0,gambar:''},
    { id: 32,nama: 'agar agar', harga:0,gambar:''},
    { id: 33,nama: 'malkist (roma)', harga:0,gambar:''},
    { id: 34,nama: 'malkist (gery)', harga:0,gambar:''},
    { id: 35,nama: 'malkist kelapa (KG)', harga:0,gambar:''},
    { id: 36,nama: 'superco (KG)', harga:0,gambar:''},
    { id: 37,nama: 'kelapa cream (roma)', harga:0,gambar:''},
    { id: 38,nama: 'roma sandwich', harga:0,gambar:''},
    { id: 39,nama: 'roma kelapa', harga:0,gambar:''},
    { id: 40,nama: 'PieBis (monde)', harga:0,gambar:''},
    { id: 41,nama: 'Keju Prochiz', harga:0,gambar:''},
    { id: 42,nama: 'Kokola Milk', harga:0,gambar:''},
    { id: 43,nama: 'Pepsodent (B)', harga:0,gambar:''},
    { id: 44,nama: 'Pepsodent (S)', harga:0,gambar:''},
    { id: 45,nama: 'closeup', harga:0,gambar:''},
    { id: 46,nama: 'Meses safari', harga:0,gambar:''},
    { id: 47,nama: 'soun (B)', harga:0,gambar:''},
    { id: 48,nama: 'soun (K)', harga:0,gambar:''},
    { id: 49,nama: 'bihun tanam (K)', harga:0,gambar:''},
    { id: 50,nama: 'bihun tanam (B)', harga:0,gambar:''},
    { id: 51,nama: 'energen', harga:0,gambar:''},
    { id: 52,nama: 'mie goreng', harga:0,gambar:''},
    { id: 53,nama: 'mie rebus',harga: 0,gambar:''},
    { id: 54,nama: 'kapal apai', harga:0,gambar:''},
    { id: 55,nama: 'kopi susu abc', harga:0,gambar:''},
    { id: 56,nama: 'indocafe', harga:0,gambar:''},
    { id: 57,nama: 'good day mocchacino', harga:0,gambar:''},
    { id: 58,nama: 'good day caramel', harga:0,gambar:''},
    { id: 59,nama: 'luwak white coffe', harga:0,gambar:''},
    { id: 60,nama: 'dancow sachet', harga:0,gambar:''},
    { id: 61,nama: 'B.M racik Ayam G.', harga:0,gambar:''},
    { id: 62,nama: 'B.M racik ikan G.', harga:0,gambar:''},
    { id: 63,nama: 'B.M racik nasi G.Ori', harga:0,gambar:''},
    { id: 64,nama: 'B.M racik G Ekstra pedas', harga:0,gambar:''},
    { id: 65,nama: 'B.M racik sayur sop', harga:0,gambar:''},
    { id: 66,nama: 'B.M racik tempe tahu', harga:0,gambar:''},
    { id: 67,nama: 'B.M racik sayur asem', harga:0,gambar:''},
    { id: 68,nama: 'masako sapi/ayam', harga:0,gambar:''},
    { id: 69,nama: 'royco sapi/ayam', harga:0,gambar:''},
    { id: 70,nama: 'ladaku', harga:0,gambar:''},
    { id: 71,nama: 'terasi', harga:0,gambar:''},
    { id: 72,nama: 'susu frisian flag coklat/putih', harga:0,gambar:''},
    { id: 73,nama: 'saori saus teriyaki', harga:0,gambar:''},
    { id: 74,nama: 'saori saus tiram', harga:0,gambar:''},
    { id: 75,nama: 'sajiku nasi G.', harga:0,gambar:''},
    { id: 76,nama: 'blueband', harga:0,gambar:''},
    { id: 77,nama: 'T.sasa kentucky ori', harga:0,gambar:''},
    { id: 78,nama: 'T.sasa bakwan spesial', harga:0,gambar:''},
    { id: 79,nama: 'T.Segitiga biru 1kg', harga:0,gambar:''},
    { id: 80,nama: 'T.segitiga biru 1/2kg', harga:0,gambar:''},
    { id: 81,nama: 'T.ketan putih', harga:0,gambar:''},
    { id: 82,nama: 'T.tapioka', harga:0,gambar:''},
    { id: 83,nama: 'T.beras putih', harga:0,gambar:''},
    { id: 84,nama: 'T.lencana merah', harga:0,gambar:''},
    { id: 85,nama: 'T.cakra kembar', harga:0,gambar:''},
    { id: 86,nama: 'T.kunci biru', harga:0,gambar:''},
    { id: 87,nama: 'mie telur 3 ayam', harga:0,gambar:''},
    { id: 88,nama: 'saori saus tiram (B)', harga:0,gambar:''},
    { id: 89,nama: 'saori saus teriyaki(B)', harga:0,gambar:''},
    { id: 90,nama: 'bango botol 385gr', harga:0,gambar:''},
    { id: 91,nama: 'saos indofooed ekstra pedas 275gr', harga:0,gambar:''},
    { id: 92,nama: 'saos indofood tomat 275gr', harga:0,gambar:''},
    { id: 93,nama: 'saos indofood sambal pedas 275gr', harga:0,gambar:''},
    { id: 94,nama: 'saos indofood pedas dasyat 275gr', harga:0,gambar:''},
    { id: 95,nama: 'royco ayam (B)', harga:0,gambar:''},
    { id: 96,nama: 'royco sapi (B)', harga:0,gambar:''},
    { id: 97,nama: 'saos belibis botol', harga:0,gambar:''},
    { id: 98,nama: 'bango refil 720gr', harga:0,gambar:''},
    { id: 99,nama: 'abc refil 685gr', harga:0,gambar:''},
    { id: 100,nama: 'indofood kecap manis refil 520gr', harga:0,gambar:''},
    { id: 101,nama: 'palmia', harga:0,gambar:''},
    { id: 102,nama: 'indofood racik bumbu spesial', harga:0,gambar:''},
    { id: 103,nama: 'tongji ori', harga:0,gambar:''},
    { id: 104,nama: 'tongji jasmine', harga:0,gambar:''},
    { id: 105,nama: 'teh jawa teh hitam', harga:0,gambar:''},
    { id: 106,nama: 'teh jawa jasmine', harga:0,gambar:''},
    { id: 107,nama: 'teh poci ori', harga:0,gambar:''},
    { id: 108,nama: 'teh poci vanila', harga:0,gambar:''},
